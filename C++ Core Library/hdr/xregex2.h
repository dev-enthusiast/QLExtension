/* $Header: /home/cvs/src/regex/src/xregex2.h,v 1.4 2014/04/01 18:43:08 c01713 Exp $ */
/****************************************************************
**
**	XREGEX2.H	- Regular expressions
**
**	$Revision: 1.4 $
**
****************************************************************/
...
DLLEXPORT reg_syntax_t re_syntax_options;

...
DLLEXPORT int re_match (struct re_pattern_buffer *buffer, const char *string,
...
/* POSIX compatibility.  */
DLLEXPORT int regcomp (regex_t *__restrict __preg,
...
__extension__
#endif
DLLEXPORT int regexec (const regex_t *__restrict __preg,
                    const char *__restrict __string, size_t __nmatch,
                    regmatch_t __pmatch[__restrict_arr],
                    int __eflags);

DLLEXPORT size_t regerror (int __errcode, const regex_t *__preg,
