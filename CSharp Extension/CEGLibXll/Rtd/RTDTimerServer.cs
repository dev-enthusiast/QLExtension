...
namespace CEGLibXll
{
    ...
    public class RTDTimerServer : IRtdServer
    {
        public class PayLoad
        {
            ...
            {
                if (functionName == "cegRefreshVolParams")
                {
                    //cegEquityVolatility.cegEquityParamsFromDB(parameters[0]);
                    //object resultInArray = cegEquityVolatility.cegDisplayEquityVolParams("EParam@" + parameters[0], 0, null);
