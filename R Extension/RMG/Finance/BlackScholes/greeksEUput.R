#
# function z=greeksEUput(S,sigma,t,K,r,options)
#
...
#-------------------------------------------------------------------
# written by Adrian Dragulescu on 21-May-2003


greeksEUput <- function(S,sigma,t,K,r,options){
...
cNd1 <- pnorm(-d1, mean=0, sd=1)  # = N(-d1) 
cNd2 <- pnorm(-d2, mean=0, sd=1)  # = N(-d2)
