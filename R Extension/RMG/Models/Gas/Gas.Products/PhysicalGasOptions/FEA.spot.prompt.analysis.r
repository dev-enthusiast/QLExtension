...
monthly.vol.corr <- function(Index= "Index of IGBBL00", Prompt="Close of NG", start.date.hist="01/01/2001",  Verbose=FALSE, Plot=T, directory)
{
...
simulate.spots.FEA <- function(MarketData, options, RemoveWkd= TRUE){
  ...
  for (d in 1:options$nodays){
    ...
    # Not sure about this.  Could be left as the line above or some stochasticity could be added as in the line below.
