...
\input{Rtables/quantities_all}

\clearpage
\input{Rtables/base_risk_by_month_all}
\input{Rtables/base_risk_by_zone_all}
...
\begin{figure}
\centerline{
 \includegraphics[width=0.80\linewidth]{Plots/base_risk_by_month_all.pdf}} 
 \caption{Basis risk by month.  The risk is calculated relative to the
 current forward marks spread.}
\end{figure}
\begin{figure}
\centerline{
 \includegraphics[width=0.80\linewidth]{Plots/base_risk_by_zone_all.pdf}} 
