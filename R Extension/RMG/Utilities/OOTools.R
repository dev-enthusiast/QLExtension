...
{
    OOFFICE_PATH = "S:/All/Risk/Software/OpenOfficePortable/App/openoffice/program/soffice"
    JOD_CONVERTER_PATH = "//ceg/cershare/Risk/Software/jodconverter-2.2.1/lib/jodconverter-cli-2.2.1.jar"
    ...
    if( verbose )  rLog("Shutting down OpenOffice listener...")
