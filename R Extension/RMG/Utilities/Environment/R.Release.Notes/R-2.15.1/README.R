...
destdir <- paste("S:/All/Risk/Software/R/prod/cran-library/",
  "R-2.15.1", sep="")

install.packages("meboot", destdir)  # for testing, has a lot of dependencies!
install.packages(c("PerformanceAnalytics", "tseries"), destdir)
install.packages("bitops", destdir)  
install.packages("mvtnorm", destdir)  
#install.packages(c("xlsxjars","xlsx"), destdir)  
install.packages("RSQLite", destdir)  
install.packages("rmongodb", destdir)  
install.packages("GenSA", destdir)
install.packages("DEoptim", destdir)
install.packages("lpSolve", destdir)
#install.packages("xlsx", destdir)
install.packages("df2json", destdir)
install.packages("ggplot2", destdir)
install.packages("corrgram", destdir)
install.packages("httr", destdir)
install.packages("hashFunction", destdir)
...
packages <- c(
  ...
  'RColorBrewer', 'Rcpp', 'RCurl', 'reshape', "reshape2", 'Rffi', 'rJava',
...
##   "R/packages/sources/R-2.15.1", sep="")
