...
library("SecDb", lib.loc="//ceg/cershare/All/Risk/Software/R/prod/site-library/R-2.15.1")
...
{    
    ...
    dealdata = ExtractBrokerData$.readData( commodity )
    ...
    finalDealData = ExtractBrokerData$.filterData( dealdata, commodity, broker )
    ...
    activitydata = ExtractBrokerData$.readData_activity( commodity )
    
    finalActivityData = ExtractBrokerData$.filterData_activity( activitydata, commodity, broker )
...
ExtractBrokerData$.readData_activity <- function( commodity )
{    
    asOfDate = ExtractBrokerData$.getAsOfDate()
...
ExtractBrokerData$.filterData_activity <- function( data, commodity, broker )
{    
